-- E-SF10 MySQL Backup
-- Format: mysql-sql-v1
-- Exported At: 2026-05-31T04:11:32.837Z
...
-- Structure for table `enrollments`
CREATE TABLE `enrollments` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `student_id` bigint unsigned NOT NULL,
  `school_year_id` bigint unsigned NOT NULL,
  `section_id` bigint unsigned NOT NULL,
  `admission_type` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'continuing',
  `status` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'enrolled',
  `enrollment_date` date DEFAULT NULL,
  `completion_status` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'not_applicable',
  `previous_school_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `previous_school_id_text` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `previous_grade_level` tinyint unsigned DEFAULT NULL,
  `transfer_in_date` date DEFAULT NULL,
  `documents_submitted` text COLLATE utf8mb4_unicode_ci,
...
(1, '2026-2027', '2026-06-06', '2027-04-07', 1, '2026-05-30 14:54:33', '2026-05-31 11:45:13', NULL),
(2, '2027-2028', NULL, NULL, 0, '2026-05-31 11:08:51', '2026-05-31 11:45:13', NULL);
...
(1, 'Mark Emil Cajes Dacoylo', 'markemil.dacoylo13@gmail.com', '$2b$10$h/OBbq0OodeJ/YXyDOsE8e1m//RG8Oznq6i2ciI1K7UbZ05aZ/o0C', 'Mark Emil', 'Cajes', 'Dacoylo', NULL, 'male', '09952788209', 'Purok 7', 'Balintawak', 'Talibon', 'Bohol', 'Region VII', 'dacs1993', '[\"admin\",\"developer\"]', 'Teacher III', 'active', '/uploads/images/1780027050609-7729f807-cc79-4229-a746-188359f96f43-profile-picture.jpg', '2026-04-18 18:23:37', '2026-05-31 11:29:18', NULL),
...
(8, 'Clara Santos Montero', 'teacher3.montero@esf10.test', '$2b$10$qJBT.Avu8gALv.9v9VQMy.GouQG.R7C41QdYsGqX2.Vguj3zYKOjS', 'Clara', 'Santos', 'Montero', NULL, 'female', '09170000001', 'Purok 1', 'Poblacion', 'Trinidad', 'Bohol', 'Region VII - Central Visayas', 'teacher3.montero', '[\"teacher\"]', 'Teacher III', 'active', NULL, '2026-05-30 18:54:59', '2026-05-30 18:54:59', NULL),
(9, 'Rogelio Diaz Mercado', 'teacher3.mercado@esf10.test', '$2b$10$qJBT.Avu8gALv.9v9VQMy.GouQG.R7C41QdYsGqX2.Vguj3zYKOjS', 'Rogelio', 'Diaz', 'Mercado', NULL, 'male', '09170000002', 'Purok 2', 'San Isidro', 'Talibon', 'Bohol', 'Region VII - Central Visayas', 'teacher3.mercado', '[\"teacher\"]', 'Teacher III', 'active', NULL, '2026-05-30 18:54:59', '2026-05-30 18:54:59', NULL),
(10, 'Marianne Cruz Villamor', 'teacher3.villamor@esf10.test', '$2b$10$qJBT.Avu8gALv.9v9VQMy.GouQG.R7C41QdYsGqX2.Vguj3zYKOjS', 'Marianne', 'Cruz', 'Villamor', NULL, 'female', '09170000003', 'Purok 3', 'Fatima', 'Ubay', 'Bohol', 'Region VII - Central Visayas', 'teacher3.villamor', '[\"teacher\"]', 'Teacher I', 'active', NULL, '2026-05-30 18:54:59', '2026-05-30 19:55:16', NULL);

-- Data for table `teachers`
INSERT INTO `teachers` (`id`, `user_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 6, '2026-05-30 15:09:26', '2026-05-31 11:59:45', NULL),
(2, 8, '2026-05-30 19:17:36', '2026-05-30 20:54:46', NULL),
(3, 9, '2026-05-30 19:17:36', '2026-05-30 19:17:36', NULL),
(4, 10, '2026-05-30 19:17:36', '2026-05-30 19:17:36', NULL),
(9, 1, '2026-05-31 11:29:37', '2026-05-31 12:00:08', NULL);
...
(1, 1, 1, 'Mabini', 2, 35, '2026-05-30 18:21:28', '2026-05-30 20:16:47', NULL),
(3, 1, 2, 'Rizal', 3, 35, '2026-05-30 19:17:36', '2026-05-30 19:17:36', NULL),
(4, 1, 3, 'Bonifacio', 4, 35, '2026-05-30 19:17:36', '2026-05-30 19:17:36', NULL),
(5, 1, 2, 'Prod', 9, 35, '2026-05-31 11:33:37', '2026-05-31 11:33:37', NULL);
...
(2, 'Maria', 'Santos', 'Cruz', NULL, 'mother', '09980000001', 'Purok 1', 'Poblacion', 'Trinidad', 'Bohol', 'Region VII - Central Visayas', NULL, '2026-05-30 19:05:54', '2026-05-30 19:05:54', NULL),
(3, 'Jose', 'Reyes', 'Dela Cruz', NULL, 'father', '09980000002', 'Purok 2', 'San Isidro', 'Talibon', 'Bohol', 'Region VII - Central Visayas', NULL, '2026-05-30 19:05:54', '2026-05-30 19:05:54', NULL),
(4, 'Elena', 'Garcia', 'Villanueva', NULL, 'mother', '09980000003', 'Purok 3', 'Fatima', 'Ubay', 'Bohol', 'Region VII - Central Visayas', NULL, '2026-05-30 19:05:54', '2026-05-30 19:05:54', NULL),
(5, 'Roberto', 'Lopez', 'Ramos', NULL, 'father', '09980000004', 'Purok 4', 'Cogon', 'Tagbilaran City', 'Bohol', 'Region VII - Central Visayas', NULL, '2026-05-30 19:05:54', '2026-05-30 19:05:54', NULL),
(6, 'Carmen', 'Mendoza', 'Bautista', NULL, 'guardian', '09980000005', 'Purok 5', 'Campao Occidental', 'Getafe', 'Bohol', 'Region VII - Central Visayas', NULL, '2026-05-30 19:05:54', '2026-05-30 19:05:54', NULL),
(7, 'Daniel', 'Flores', 'Santiago', NULL, 'father', '09980000006', 'Purok 6', 'Anonang', 'Buenavista', 'Bohol', 'Region VII - Central Visayas', NULL, '2026-05-30 19:05:54', '2026-05-30 19:05:54', NULL),
(8, 'Lucia', 'Torres', 'Navarro', NULL, 'mother', '09980000007', 'Purok 7', 'Poblacion Centro', 'Clarin', 'Bohol', 'Region VII - Central Visayas', NULL, '2026-05-30 19:05:54', '2026-05-30 19:05:54', NULL),
(9, 'Ramon', 'Aquino', 'Castillo', NULL, 'guardian', '09980000008', 'Purok 8', 'Dagnawan', 'Sagbayan', 'Bohol', 'Region VII - Central Visayas', NULL, '2026-05-30 19:05:54', '2026-05-30 19:05:54', NULL),
(10, 'Teresa', 'Rivera', 'Morales', NULL, 'mother', '09980000009', 'Purok 9', 'Pooc Occidental', 'Tubigon', 'Bohol', 'Region VII - Central Visayas', NULL, '2026-05-30 19:05:54', '2026-05-30 19:05:54', NULL),
(11, 'Antonio', 'Fernandez', 'Soriano', NULL, 'father', '09980000010', 'Purok 10', 'Bentig', 'Calape', 'Bohol', 'Region VII - Central Visayas', NULL, '2026-05-30 19:05:54', '2026-05-30 19:05:54', NULL);
...
(2, '200000000001', 'Andrea', 'Santos', 'Cruz', NULL, 'female', '2018-01-15', 'Trinidad, Bohol', 'Purok 1', 'Poblacion', 'Trinidad', 'Bohol', 'Region VII - Central Visayas', 'active', NULL, '2026-05-30 18:54:59', '2026-05-30 18:54:59', NULL),
(3, '200000000002', 'Miguel', 'Reyes', 'Dela Cruz', NULL, 'male', '2018-02-22', 'Talibon, Bohol', 'Purok 2', 'San Isidro', 'Talibon', 'Bohol', 'Region VII - Central Visayas', 'active', NULL, '2026-05-30 18:54:59', '2026-05-30 18:54:59', NULL),
(4, '200000000003', 'Sophia', 'Garcia', 'Villanueva', NULL, 'female', '2018-03-10', 'Ubay, Bohol', 'Purok 3', 'Fatima', 'Ubay', 'Bohol', 'Region VII - Central Visayas', 'active', NULL, '2026-05-30 18:54:59', '2026-05-30 18:54:59', NULL),
(5, '200000000004', 'Nathan', 'Lopez', 'Ramos', NULL, 'male', '2018-04-18', 'Tagbilaran City, Bohol', 'Purok 4', 'Cogon', 'Tagbilaran City', 'Bohol', 'Region VII - Central Visayas', 'active', NULL, '2026-05-30 18:54:59', '2026-05-30 18:54:59', NULL),
(6, '200000000005', 'Ella', 'Mendoza', 'Bautista', NULL, 'female', '2018-05-06', 'Getafe, Bohol', 'Purok 5', 'Campao Occidental', 'Getafe', 'Bohol', 'Region VII - Central Visayas', 'active', NULL, '2026-05-30 18:54:59', '2026-05-30 18:54:59', NULL),
(7, '200000000006', 'Gabriel', 'Flores', 'Santiago', NULL, 'male', '2018-06-14', 'Buenavista, Bohol', 'Purok 6', 'Anonang', 'Buenavista', 'Bohol', 'Region VII - Central Visayas', 'active', NULL, '2026-05-30 18:54:59', '2026-05-30 18:54:59', NULL),
(8, '200000000007', 'Isabella', 'Torres', 'Navarro', NULL, 'female', '2018-07-09', 'Clarin, Bohol', 'Purok 7', 'Poblacion Centro', 'Clarin', 'Bohol', 'Region VII - Central Visayas', 'active', NULL, '2026-05-30 18:54:59', '2026-05-30 18:54:59', NULL),
(9, '200000000008', 'Liam', 'Aquino', 'Castillo', NULL, 'male', '2018-08-25', 'Sagbayan, Bohol', 'Purok 8', 'Dagnawan', 'Sagbayan', 'Bohol', 'Region VII - Central Visayas', 'active', NULL, '2026-05-30 18:54:59', '2026-05-30 18:54:59', NULL),
(10, '200000000009', 'Alyssa', 'Rivera', 'Morales', NULL, 'female', '2018-09-12', 'Tubigon, Bohol', 'Purok 9', 'Pooc Occidental', 'Tubigon', 'Bohol', 'Region VII - Central Visayas', 'active', NULL, '2026-05-30 18:54:59', '2026-05-30 18:54:59', NULL),
(11, '200000000010', 'Joshua', 'Fernandez', 'Soriano', NULL, 'male', '2018-10-30', 'Calape, Bohol', 'Purok 10', 'Bentig', 'Calape', 'Bohol', 'Region VII - Central Visayas', 'active', '/uploads/images/1780141991416-df590370-f97f-489e-b7f5-c4b7d8e702cf-profile-picture.png', '2026-05-30 18:54:59', '2026-05-30 19:53:11', NULL);
...
(1, 1, 1, 4, 'continuing', 'enrolled', '2026-06-06', 'not_applicable', NULL, NULL, NULL, NULL, NULL, NULL, '2026-05-30 18:36:43', '2026-05-30 19:48:59', NULL),
(2, 10, 1, 4, 'continuing', 'enrolled', '2026-06-06', 'not_applicable', NULL, NULL, NULL, NULL, NULL, NULL, '2026-05-30 19:47:33', '2026-05-30 19:49:05', NULL),
(3, 2, 1, 5, 'continuing', 'enrolled', '2026-06-01', 'not_applicable', NULL, NULL, NULL, NULL, NULL, 'Remarks', '2026-05-31 11:34:21', '2026-05-31 11:34:21', NULL),
(4, 6, 1, 5, 'continuing', 'enrolled', '2026-06-01', 'not_applicable', NULL, NULL, NULL, NULL, NULL, NULL, '2026-05-31 11:37:06', '2026-05-31 11:37:06', NULL),
(5, 7, 1, 5, 'continuing', 'enrolled', '2026-06-01', 'not_applicable', NULL, NULL, NULL, NULL, NULL, NULL, '2026-05-31 11:37:16', '2026-05-31 11:37:16', NULL),
(6, 8, 1, 5, 'continuing', 'enrolled', '2026-06-01', 'not_applicable', NULL, NULL, NULL, NULL, NULL, NULL, '2026-05-31 11:37:25', '2026-05-31 11:37:31', NULL),
(7, 11, 1, 5, 'continuing', 'enrolled', '2026-06-01', 'not_applicable', NULL, NULL, NULL, NULL, NULL, NULL, '2026-05-31 11:37:57', '2026-05-31 11:37:57', NULL),
(8, 9, 1, 5, 'continuing', 'enrolled', '2026-06-01', 'not_applicable', NULL, NULL, NULL, NULL, NULL, 'sasd', '2026-05-31 11:38:07', '2026-05-31 11:38:07', NULL),
(9, 3, 1, 5, 'continuing', 'enrolled', '2026-06-01', 'not_applicable', NULL, NULL, NULL, NULL, NULL, 'asdasd', '2026-05-31 11:38:17', '2026-05-31 11:38:17', NULL),
(10, 5, 1, 5, 'continuing', 'enrolled', '2026-06-01', 'not_applicable', NULL, NULL, NULL, NULL, NULL, 'asdasd', '2026-05-31 11:38:28', '2026-05-31 11:38:28', NULL),
(11, 4, 1, 5, 'continuing', 'enrolled', '2026-06-01', 'not_applicable', NULL, NULL, NULL, NULL, NULL, NULL, '2026-05-31 11:38:39', '2026-05-31 11:38:39', NULL);
...
(2, 11, 11, 'Father', 1, '2026-05-30 19:14:50', '2026-05-30 19:14:50', NULL);
