...
const tableDefinitions: Record<BackupTableName, TableDefinition> = {
  ...
  sections: {
    columns: ["id", "school_year_id", "grade_level", "section_name", "adviser_id", "capacity_limit", "created_at", "updated_at", "deleted_at"],
    orderBy: "id ASC",
    datetimeColumns: ["created_at", "updated_at", "deleted_at"],
    dateColumns: [],
    jsonColumns: [],
  ...
  enrollments: {
    columns: ["id", "student_id", "school_year_id", "section_id", "admission_type", "status", "enrollment_date", "completion_status", "previous_school_name", "previous_school_id_text", "previous_grade_level", "transfer_in_date", "documents_submitted", "remarks", "created_at", "updated_at", "deleted_at"],
    orderBy: "id ASC",
    datetimeColumns: ["created_at", "updated_at", "deleted_at"],
    dateColumns: ["enrollment_date", "transfer_in_date"],
    jsonColumns: [],
  },
  users: {
    columns: [
